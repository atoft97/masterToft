...
class BaselineLive:
    ...
    def __init__(self, modelName, useDepth, modelType,  goalX, goalY):
        ...
        if (modelType=="rgb"):
            ...
            self.sub_range = rospy.Subscriber("/img_node/range_image", Image, self.processRange,queue_size=1, buff_size=stortTall)
            self.sub_signal = rospy.Subscriber("/img_node/signal_image", Image, self.processSignal,queue_size=1, buff_size=stortTall)
            self.sub_reflec = rospy.Subscriber("/img_node/reflec_image", Image, self.processReflec,queue_size=1, buff_size=stortTall)
        ...
        self.sub_pos_heading = rospy.Subscriber("/warpath/navigation/odometry_integrated_center_ned", Odometry, self.processHeadingAndPos,queue_size=1)
    ...
    def timerFunction(self, event=None):
        ...
        rosRotationX = odom.pose.pose.orientation.y
        rosRotationY = odom.pose.pose.orientation.x
        ...
        #    self.last_processed_image = rosImage
            ...
            xrotationEtter = math.degrees(eulerOdom[2])
    ...
    def timerLidar(self, event=None):
        ...
        #    self.last_processed_image = rosImage
            ...
            print(recomendedDirection)
            print("gloabl 1", globalDirection)
