...
from mask_former_semantic_dataset_mapper_test_combined import MaskFormerSemanticDatasetMapperTestCombined
from mask_former_semantic_dataset_mapper_combined import MaskFormerSemanticDatasetMapperCombined
import sys
...
#register_combined_dataset(name="ffi_train_stuffonly",   metadata={}, sem_seg_root="croppedDataset/train/idSegment/lidar", lidar_root="croppedDataset/train/numpyImage/lidar", rgb_root="croppedDataset/train/image/rgb")
#register_combined_dataset(name="ffi_val_stuffonly", metadata={}, sem_seg_root="croppedDataset/train/idSegment/lidar", lidar_root="croppedDataset/train/numpyImage/lidar", rgb_root="croppedDataset/train/image/rgb")
...
class Trainer(DefaultTrainer):
    ...
    def build_hooks(self):
        ...
        mapper = MaskFormerSemanticDatasetMapperTestCombined(self.cfg, True)
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        if evaluator_type == "mapillary_vistas_panoptic_seg" and cfg.MODEL.MASK_FORMER.TEST.SEMANTIC_ON:
            evaluator_list.append(SemSegEvaluator(dataset_name, distributed=True, output_dir=output_folder))
        # Cityscapesbuild_detection_test_loader
    ...
    def build_test_loader(cls, cfg, dataset_name):
        ...
        mapper = MaskFormerSemanticDatasetMapperTestCombined(cfg, True)
    ...
    def build_train_loader(cls, cfg):
        ...
        if cfg.INPUT.DATASET_MAPPER_NAME == "mask_former_semantic":
            #mapper = MaskFormerSemanticDatasetMapper(cfg, True)
            mapper = MaskFormerSemanticDatasetMapperCombined(cfg, True)
...
def setup(args):
    ...
    #cfg.MODEL.WEIGHTS = 'models/combinedModel.pth'
    #obs obs new weights
    ...
    cfg.OUTPUT_DIR = "./combined7Layers"
