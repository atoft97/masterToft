...
#register_ffi_png_dataset(name="ffi_test_stuffonly", metadata={}, sem_seg_root="ffiRGBdataset3/test/idSegment", image_root="ffiRGBdataset3/test/image")
...
register_ffi_png_dataset(name="ffi_test_stuffonly",   metadata={}, sem_seg_root="ffiLiDARdataset/test/idSegment", image_root="ffiLiDARdataset/test/3channelImage")
...
def setup(args):
    ...
    #cfg.MODEL.WEIGHTS = 'models/ffiRGBLast.pth'
    cfg.MODEL.WEIGHTS = 'models/3channelLidar.pth'
...
mapper = MaskFormerSemanticDatasetMapperTest(cfg, True, numpyData=False)
