...
class Inferance:
    ...
    def visualise_predicted_frame(self, frame, predictions, fileName):
        ...
        #print(classesImage)
        #classesImage = cv2.imread(f"ffiRGBdataset3/test/idSegment/{fileName}", -1)
    ...
    def visEachClass(self, frame, predictions, fileName):
        ...
        if (self.loggingFolder != ""):
            ...
            for classNumber in range(len(sem_seg)):
                ...
                cv2.imwrite("outputImages/LiDAR/" + self.loggingFolder + "/" + fileName[:-4] + "/" + str(classNumber) + ".png", pred*5)
    ...
    def segmentImage(self, image, fileName):
        ...
        if (self.loggingFolder != ""):
            ...
            vis_panoptic = self.visualise_predicted_frame(image, predictedPanoptic, fileName)
