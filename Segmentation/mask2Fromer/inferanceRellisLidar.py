...
aug = T.ResizeShortestEdge([cfg.INPUT.MIN_SIZE_TESTrgb_img, cfg.INPUT.MIN_SIZE_TEST], cfg.INPUT.MAX_SIZE_TEST)
...
class InferanceRellisLidar:
    ...
    def registerDataset(self):
        ...
        register_numpy_dataset(name="ffi_val_stuffonly", metadata={}, sem_seg_root="lidarDataset/val/labelsId", image_root="lidarDataset/val/numpyImage")
        ...
        MetadataCatalog.get("ffi_test_stuffonly").set(stuff_classes=['other', 'Grass', 'CameraEdge', 'Vehicle', 'Person', 'Bush', 'Puddle', 'Building', 'Dirtroad', 'Sky', 'Large_stone', 'Forrest', 'Gravel'])
        MetadataCatalog.get("ffi_test_stuffonly").set(stuff_colors=[[255,255,255], [64,255,38], [70,70,70], [150,0,191], [255,38,38], [232,227,81], [255,179,0], [255,20,20], [191,140,0], [15,171,255], [200,200,200], [46,153,0], [180,180,180]])
        '''
    ...
    def visualise_predicted_frame(self, frame, predictions):
        ...
        classesImage = cv2.imread("/lhome/asbjotof/asbjotof/2022/masterToft/LiDARsegmentation/mask2Former/inferance/lidarDataset/test/labelsId/1581623790_394.png", -1)
        #print("fint")
    ...
    def visEachClass(self, frame, predictions, fileName):
        ...
        classImage = cv2.imread("/lhome/asbjotof/asbjotof/2022/masterToft/LiDARsegmentation/mask2Former/inferance/lidarDataset/test/labelsId/1581623790_394.png", -1)
        #print(classImage)
    ...
    def writeLabelMap(self):
        ...
        with open("outputImages/LiDAR/" + self.loggingFolder + "/" + "outputDatasett" + "/labelmap.txt", 'w') as f:
            for i in range(len(self.metadata.get("stuff_classes"))):
                ...
                f.write(":")
                print(str(self.metadata.get("stuff_colors")[i]))
