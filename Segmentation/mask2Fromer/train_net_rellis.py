...
register_relllis_png_dataset(name="ffi_test_stuffonly", metadata={}, sem_seg_root="rgb/test/labelsId", image_root="rgb/test/image")
...
def setup(args):
    ...
    #cfg.MODEL.WEIGHTS = 'models/rellisBRG1t.pth'
    ...
    epoch = 3302
    cfg.SOLVER.MAX_ITER = epoch*3
    cfg.SOLVER.STEPS = []
    #cfg.TEST.EVAL_PERIOD = epoch
    cfg.TEST.EVAL_PERIOD = 1
    cfg.SOLVER.CHECKPOINT_PERIOD = epoch

    #cfg.MODEL.ROI_HEADS.NUM_CLASSES = 0
    cfg.MODEL.SEM_SEG_HEAD.NUM_CLASSES = 19

    cfg.INPUT.MASK_FORMAT = "bitmask"
    cfg.OUTPUT_DIR = "./rellisRGB1tBRGTest"
