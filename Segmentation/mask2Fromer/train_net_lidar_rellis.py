...
'''
register_numpy_dataset(name="ffi_train_stuffonly",   metadata={}, sem_seg_root="datasetLidarTilNo/train/panoptic_stuff_train", image_root="datasetLidarTilNo/train/imagesNumpy")
register_numpy_dataset(name="ffi_val_stuffonly", metadata={}, sem_seg_root="datasetLidarTilNo/train/panoptic_stuff_train", image_root="datasetLidarTilNo/train/imagesNumpy")
        ...
        if evaluator_type in ["sem_seg", "ade20k_panoptic_seg"]:
            evaluator_list.append(
                SemSegEvaluator(
                    dataset_name,
                    distributed=True,
                    output_dir=output_foldeffi_val_stuffonlyr,
                )
            )
...
def setup(args):
    ...
    cfg.OUTPUT_DIR = "./rellisLidarLr000005_4"
