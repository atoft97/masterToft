...
from detectron2.data.datasets import register_coco_panoptic_separated, register_coco_panoptic, load_sem_seg
import sys
import time
...
def write_to_csv(new_data, fileName):
    ...
    with open(fileName, 'a') as f_object:
        writer_object = DictWriter(f_object, fieldnames=['IoU-Sky', 'mACC', 'IoU-Large_stone', 'pACC', 'ACC-Person', 'mIoU', 'IoU-CameraEdge', 'fwIoU', 'IoU-Vehicle', 'IoU-Person', 'ACC-Building', 'ACC-Vehicle', 'IoU-Puddle', 'ACC-Large_stone', 'IoU-Dirtroad', 'IoU-Bush', 'ACC-Forrest', 'ACC-Sky', 'ACC-Gravel', 'ACC-Grass', 'IoU-Forrest', 'IoU-Gravel', 'ACC-Puddle', 'ACC-Bush', 'IoU-Grass', 'IoU-Building', 'ACC-Dirtroad', 'ACC-CameraEdge', 'IoU-RoadNotDrivable', 'ACC-Car', 'ACC-Pavement', 'IoU-Car', 'ACC-GoodRoad', 'IoU-Pavement', 'IoU-background', 'ACC-background', 'ACC-RoadNotDrivable', 'IoU-GoodRoad'])
...
testName =  "pq/ntnu15Test"+ timeStamp + ".csv"
trainName = "pq/ntnu15Train"+ timeStamp + ".csv"
...
MetadataCatalog.get("ffi_train_stuffonly").set(stuff_colors=[[64,255,38], [70,70,70], [150,0,191], [255,38,38], [232,227,81], [255,179,0], [255,20,20], [191,140,0], [15,171,255], [200,200,200], [46,153,0], [180,180,180], [255,255,255], [32,128,192], [32,224,224], [0,96,96],[211,134,128]])
...
MetadataCatalog.get("ffi_val_stuffonly").set(stuff_classes=['Grass', 'CameraEdge', 'Vehicle', 'Person', 'Bush', 'Puddle', 'Building', 'Dirtroad', 'Sky', 'Large_stone', 'Forrest', 'Gravel', "background", "Car", "GoodRoad", "Pavement", "RoadNotDrivable"])
MetadataCatalog.get("ffi_val_stuffonly").set(stuff_colors=[[64,255,38], [70,70,70], [150,0,191], [255,38,38], [232,227,81], [255,179,0], [255,20,20], [191,140,0], [15,171,255], [200,200,200], [46,153,0], [180,180,180], [255,255,255], [32,128,192], [32,224,224], [0,96,96],[211,134,128]])

print("\n")
print(MetadataCatalog.get("ffi_train_stuffonly"))
print("\n")

#semSegDict = load_sem_seg()
